...
// Automatically uses Render for your live site, and localhost for your computer!
const API = window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1"
  ? "http://127.0.0.1:8000"
  : "https://jobfit-ai-backend-qisq.onrender.com";
...
function App() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // API Request - Headers configuration removed to let Axios build dynamic boundaries natively
      ...
      alert("Upload failed. Check terminal/console logs.")
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen flex bg-gradient-to-br from-[#0f172a] via-[#111827] to-[#1e1b4b] text-white">
      ...
      <aside className="w-72 bg-white/5 backdrop-blur-xl border-r border-white/10 p-8 hidden lg:flex flex-col">
        ...
        <div className="flex items-center gap-4 mb-16">
          ...
          <div>
            <h1 className="text-3xl font-bold">JobFit AI</h1>
            <p className="text-gray-400 text-sm">AI Resume Optimization Platform</p>
          </div>
        </div>
      ...
      <main className="flex-1 overflow-y-auto p-8 lg:p-12">
        ...
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[36px] p-10 shadow-2xl">
          <div className="flex flex-col lg:flex-row lg:justify-between gap-12">
            ...
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 bg-cyan-400/10 border border-cyan-400/20 px-5 py-2 rounded-full mb-6">
                ...
                <span className="text-cyan-300 text-sm">AI-Powered ATS Optimization</span>
              </div>
              <h1 className="text-6xl font-bold leading-tight">JobFit AI</h1>
              <p className="text-gray-300 mt-6 text-lg leading-relaxed">
                Analyze resumes against real job descriptions, detect missing skills, optimize ATS score,
            ...
            <label className="w-full lg:w-[420px] h-64 border-2 border-dashed border-cyan-400/30 rounded-3xl flex flex-col items-center justify-center cursor-pointer hover:border-cyan-400 hover:bg-cyan-400/5 transition-all duration-300 bg-black/20">
              ...
              <p className="text-gray-400 mt-2">PDF files only</p>
          ...
          {/* Job Description */}
          <div className="mt-10">
            <label className="block text-xl font-semibold mb-4">Paste Job Description</label>
            <textarea
              rows="8"
